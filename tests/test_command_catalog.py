...
def test_weldborn_tool_catalog_has_one_cli_verb_per_tool():
    status_tool_names = {
        ...
        "weldborn.startup.snapshot",
        "weldborn.startup.skip",
        "weldborn.startup.new_game",
        "weldborn.communication.snapshot",
        "weldborn.communication.advance",
        "weldborn.communication.choose",
        "weldborn.contract.snapshot",
        "weldborn.contract.accept",
        "weldborn.world.snapshot",
        "weldborn.placement.confirm",
        "weldborn.factory_design.begin",
        "weldborn.factory_design.rectangle",
        "weldborn.factory_design.save",
